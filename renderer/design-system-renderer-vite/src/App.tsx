...
import { DesignPromptView } from '@/views/design-prompt/DesignPromptView'
...
// R-96 fix #3 · Cool slot mode=dark → 移暗黑组(对齐 slot meta:"Instrument Dark · Electric Blue")
// R-95 trim 后版本号同步 swiss v0.8 / festive-royal v0.3 / festive-editorial v0.3
const STYLE_GROUPS: StyleGroup[] = [
  {
    label: '明亮',
    items: [
      { key: 'warm', label: 'Confident Warmth', sublabel: 'Ivory Ember', version: 'v1.0.2' },
      { key: 'swiss', label: 'Swiss Systematic', sublabel: 'Editorial Blue', version: 'v0.8' },
      { key: 'festive-editorial', label: 'Festive Editorial', sublabel: 'Crimson Wash', version: 'v0.3' },
    ],
  },
  {
    label: '暗黑',
    items: [
      { key: 'theatre', label: 'Theatre Dark', sublabel: 'Hermès Orange', version: 'v6.7.2' },
      { key: 'cool', label: 'Instrument Dark', sublabel: 'Electric Blue', version: 'v0.5.2' },
    ],
  },
  {
    label: '彩色',
    items: [
      { key: 'festive-royal', label: 'Festive Royal', sublabel: 'Crimson Gold', version: 'v0.3' },
    ],
  },
]
