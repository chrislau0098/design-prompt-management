---
style_name: 庆典皇室 · 朱砂金
description: 以朝代、尊贵、庆典的视觉语言搭建整页深朱红底面、金色衬线大字主导焦点、朱砂印章节奏分隔段落、东方礼仪秩序贯穿全局,整体呈现庄重、尊贵、喜庆的朝代气质。适用于春节年度战报、重大节庆汇报、品牌庆典、国货品牌业绩、传统行业报告等场景。当用户需求强调中国风、整页朱红、金色衬线、春节、朝代、节日、东方庆典时优先选用本风格
---
