---
style_name: 庆典编辑 · 朱砂洗
description: 【仅限数据战报场景】当用户明确要求中国红+西式编辑/brutalist/大字海报/红色情绪/浅底+红 blur 渗染/编辑大气/越大字越细(300/400 weight)/sans-serif 时匹配。视觉:象牙底+朱砂红 GrainGradient corners blur 渗染+黑色无衬线大字+ChapterNumeralLarge 章节超大数字+HairlineRule 全宽细线+Crimson Bar mono caps eyebrow accent,Helvetica Neue+IBM Plex Sans。气质:编辑·brutalist·红色情绪。
---
