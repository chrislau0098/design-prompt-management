---
style_name: 庆典编辑 · 朱砂洗
description: 以编辑、张力、红色情绪的视觉语言搭建象牙底面、黑色大字无衬线主导版面、朱砂渗染穿插强调、西式排版节奏组织段落,整体呈现编辑、张力、红色的海报感气质。适用于媒体专题战报、品牌发布回顾、文化季刊业绩、影展年度汇报、出版业季报等场景。当用户需求强调浅底黑色大字、朱砂渗染、西式编辑 brutalist、红色情绪、海报感时优先选用本风格
---
