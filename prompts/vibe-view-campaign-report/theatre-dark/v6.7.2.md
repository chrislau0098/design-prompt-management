---
style_name: 剧场暗夜 · 爱马仕橙
description: 【仅限数据战报场景】当用户明确要求暗黑/深色/dark mode/戏剧/剧场/高对比/spotlight/镜头感/银幕/深邃/Bloomberg/影院感时匹配。视觉:暗夜剧场——银幕黑底+爱马仕橙单一强调,MeshGradient 暖光着色器+颗粒幕布,Inter+IBM Plex Mono,Double-Bezel 卡片+章节圆形 stamp marker。气质:深邃·戏剧·镜头感。
---
