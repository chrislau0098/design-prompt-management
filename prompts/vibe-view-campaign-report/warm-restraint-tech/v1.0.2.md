---
style_name: 克制暖意 · 象牙余烬
description: 【仅限数据战报场景】当用户明确要求明亮/浅色/白底/light mode/现代简洁/品牌报告/年报/杂志风/editorial/对外发布时匹配。视觉:明亮暖调——象牙底+琥珀橙强调,橙色大数字为焦点,GrainGradient 暖光着色器,Geist+Noto Sans SC,章节 hairline+mono 编号节奏。气质:温暖·自信·品牌感。
---
