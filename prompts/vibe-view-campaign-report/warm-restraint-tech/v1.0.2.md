...
description: 以温暖、自信、品牌的视觉语言搭建象牙底面、琥珀橙强调、橙色大数字作为焦点、人文无衬线字体主导、章节细线分隔段落,整体呈现温暖、克制、品牌的明亮气质。适用于品牌年度报告、消费品季度战报、DTC 品牌汇报、生活方式品牌年度复盘、暖调品牌发布等场景。当用户需求强调明亮、暖调品牌、象牙琥珀橙、人文无衬线、对外发布场景时优先选用本风格
---
