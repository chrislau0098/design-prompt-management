...
```
*Note (v0.4 占位)*: Dithering props are reasonable placeholders. Actual paper-shaders Dithering API confirmed by HTML sub-agent — see v0.4.1 patch for finalized props.
