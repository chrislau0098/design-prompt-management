---
style_name: 瑞士系统 · 编辑蓝
description: 【仅限数据战报场景】当用户明确要求系统/网格/严谨/编辑/Helvetica/瑞士/国际主义/全大写/minimal/极简/黑粗线/排版主导/无装饰时匹配。视觉:浅灰底+ALL CAPS Helvetica/Inter Display 排版主导+钴蓝单一焦点+黑粗线分隔+Dithering 中性灰着色器,章节用 ShadBadge outline+ShadSeparator(无 SealStamp/ChapterStamp SVG)。气质:系统·严谨·克制。
---
