---
style_name: 瑞士系统 · 编辑蓝
description: 以系统、严谨、克制的视觉语言搭建浅灰底面、黑色粗线分隔、钴蓝单一焦点、全大写排版主导版面、圆形序号点缀章节,整体呈现系统、严谨、minimal 的国际主义气质。适用于系统化产品战报、编辑式季度复盘、国际化品牌报告、工程文档化战报、排版主导汇总等场景。当用户需求强调瑞士系统、网格、全大写排版、黑色粗线、钴蓝单焦点、排版主导时优先选用本风格
---
